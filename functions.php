<?php
	...
	function saveUserInterest ($interest) {
		...
		{
			echo "juba olemas";
			// parast returni midagi edasi ei tehta funktsioonis
			return;
		}
		
		// kui ei olnud siis sisestan huvi
